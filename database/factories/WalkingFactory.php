...
/**
 * @extends Factory<Walking>
 */
class WalkingFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'speed' => $this->faker->numberBetween(500, 5000),
            'distance' => $this->faker->numberBetween(10, 100),
            ...
            'watch_walking_distance' => $this->faker->numberBetween(10, 100),
