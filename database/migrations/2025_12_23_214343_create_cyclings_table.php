...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('cyclings', function (Blueprint $table) {
            ...
            $table->integer('ttl');
            $table->integer('act');
            $table->integer('watch_cadence')->nullable();
            $table->integer('watch_rest_energy')->nullable();
            $table->integer('watch_heart_rate')->nullable();
            $table->integer('watch_cycling_power')->nullable();
            $table->integer('watch_cycling_speed')->nullable();
            $table->integer('watch_cycling_distance')->nullable();
